package com.senseonics.accuchekbleapp.accuchekble.Service;
...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "android.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "android.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "android.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "android.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "android.EXTRA_DATA";

    public static String String_MTR01556566_GLUCOSEService =
            "00001808-0000-1000-8000-00805f9b34fb";
    public final static ParcelUuid ParcelUuid_MTR01556566_GLUCOSEService =
            ParcelUuid.fromString(String_MTR01556566_GLUCOSEService);
    public final static UUID UUID_MTR01556566_GLUCOSEService =
            UUID.fromString(String_MTR01556566_GLUCOSEService);
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        /*if (UUID_MTR01556566_GLUCOSEService.equals(characteristic.getUuid())) {
