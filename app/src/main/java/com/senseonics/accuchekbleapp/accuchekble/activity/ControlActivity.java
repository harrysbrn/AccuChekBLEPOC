...
public class ControlActivity extends AppCompatActivity {
    ...
    /*private BroadcastReceiver bondUpdateReceiver = new BroadcastReceiver() {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //registerReceiver(bondUpdateReceiver, makeBondUpdateIntentFilter());
    ...
    protected void onDestroy() {
        super.onDestroy();
        //unregisterReceiver(bondUpdateReceiver);
